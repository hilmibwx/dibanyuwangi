    ...
    <div class="container">
        ...
        <div class="form-group ml-5">
            ...
            <div class="col-sm-7">
                ...
                <input type="text" name='name' class="form-control {{$errors->first('name') ? "is-invalid" : "" }} " value="{{old('name') ? old('name') : $general->name}}" id="name" placeholder="Ketikkan nama jika tidak ada logo">
