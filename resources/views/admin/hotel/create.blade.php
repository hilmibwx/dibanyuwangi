    ...
    <div class="container">
        ...
        <div class="form-group ml-5">
            ...
            <div class="col-sm-9">
                ...
                <input type="text" name='title' class="form-control {{$errors->first('title') ? "is-invalid" : "" }} " value="{{old('title')}}" id="title" placeholder="ex: Bwx Hotel">
        ...
        <div class="form-group ml-5">
            ...
            <div class="col-sm-9">
                ...
                {{-- <input type="text" name='title' class="form-control {{$errors->first('title') ? "is-invalid" : "" }} " value="{{old('title')}}" id="title" placeholder="ex: Pulau Merah"> --}}
        ...
        <div class="form-group ml-5">
            ...
            <div class="col-sm-9">
                ...
                <input type="text" name='link' class="form-control {{$errors->first('link') ? "is-invalid" : "" }} " value="{{old('link')}}" id="link" placeholder="ex: Booking.com">
        ...
        <div class="form-group ml-5">
            ...
            <div class="col-sm-9">
                ...
                <input type="text" name='keyword' class="form-control {{$errors->first('keyword') ? "is-invalid" : "" }} " value="{{old('keyword')}}" id="keyword" placeholder="ex: Pulau Merah">
        ...
        <div class="form-group ml-5">
            ...
            <div class="col-sm-9">
                ...
                <input type="text" name='meta_desc' class="form-control {{$errors->first('meta_desc') ? "is-invalid" : "" }} " value="{{old('meta_desc')}}" id="meta_desc" placeholder="Meta Desc">
